...
!(function () {
  ...
  var slideIn = function ($this, from) {
      ...
      $this.performCSSTransition(
        ...
        function () {
          $this
            .resetInlineCSS("position", "left", "opacity", "display")
    ...
    slideOut = function ($this, to) {
      ...
      $this.performCSSTransition(
        { left: to == "left" ? "-100%" : "100%", opacity: 0 },
        arguments[0] || 250,
        function () {
          $this
            .css({ display: "none" })
  ...
  $(".w-logos.type_carousel").each(function () {
    $us.getScript(
      ...
      function () {
        ...
        if (
          parseInt($list.data("breakpoint_1_width")) > 0 &&
          parseInt($list.data("breakpoint_1_cols"))
        ) {
          breakpoint1_width = parseInt($list.data("breakpoint_1_width"));
          breakpoint1_cols = parseInt($list.data("breakpoint_1_cols"));
        }
        if (
          parseInt($list.data("breakpoint_2_width")) > 0 &&
          parseInt($list.data("breakpoint_2_cols"))
        ) {
          breakpoint2_width = parseInt($list.data("breakpoint_2_width"));
          breakpoint2_cols = parseInt($list.data("breakpoint_2_cols"));
        }
        if (
          parseInt($list.data("breakpoint_3_width")) > 0 &&
          parseInt($list.data("breakpoint_3_cols"))
        ) {
    ...
    $us.getScript(
      ...
      function () {
        ...
        $list.owlCarousel({
          ...
          margin: 30,
          responsive: {
            0: { items: 1, autoHeight: !0, autoplay: !1 },
