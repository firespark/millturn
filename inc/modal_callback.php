<div class="plainmodal plainmodal-modal" id="callback-modal">
    ...
    <div>
        ...
        <div id="orderRing">
            ...
            <form class="wpcf7-form init">
                <div action="" class="plainmodal-form">
                    <div class="plainmodal-title">
                        <?php echo $optionsArr['form_callback_title'];?>
                    </div>
                    <p class="policy">
                        <?php echo $optionsArr['form_callback_description'];?>
                    </p>
                    ...
                    <div class="modalInner plainmodal-form">
                        <p>
                            ...
                            <br />
                            <button class="plainmodal-btn btn"><span class="left-line"><?php _e('Order ring', 'millturn');?></span></button>
                        </p>
                        <p class="policy">
                            <?php echo $optionsArr['form_callback_agreement'];?>
                        </p>
                    </div>
                </div>
                <p style="display: none !important;">
                    <input type="hidden" id="ak_js" name="_wpcf7_ak_js" value="227"/>
