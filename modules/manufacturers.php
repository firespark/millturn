<?php
$moduleOptions = get_module_options('manufacturers');
?>

        <div class="partners-section">
            <div class="max-width">
                <h2><?php echo $moduleOptions['manufacturers_title'];?></h2>
                <?php if(!empty($moduleOptions['manufacturer'])):?>
                <div class="partners-slider" id="manufacturers-slider">
                    <div class="partners-slider__block">
                        ...
                        <div class="slider-partners__container" id="slider-manufacturers__container">
                            <?php foreach($moduleOptions['manufacturer'] as $manufacturer):?>
                            <div class="partners__item">
                                <?php if($manufacturer['url']):?>
                                <a href="<?php echo $manufacturer['url'];?>" target="_blank" rel="nofollow">
                                <?php endif;?>
                                    <img src="<?php echo $manufacturer['img']['url'];?>" class="slider-any__img" alt="<?php echo $manufacturer['img']['alt'];?>">
                                <?php if($manufacturer['url']):?>
                                </a>
                                <?php endif;?>
                            </div>
